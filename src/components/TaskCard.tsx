...
import { BidiLines } from './ui/BidiText'
        ...
        {isEditing ? (
          <div className="w-full space-y-2">
            <input
              ...
              dir={getLineDirection(editValue)}
          ...
          <BidiLines text={item.content} className="w-full" lineClassName="text-sm font-medium text-on-surface" />
        )}
