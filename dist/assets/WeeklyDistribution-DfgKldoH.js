import{u as k,b as N,r as m,j as e}from"./index-ChrtCVMb.js";import{A as p,u as v}from"./AppLayout-D_0Ab-Rl.js";import{D as w}from"./DayCardDistribution-BCag9gdj.js";import{u as S}from"./useBrainDumpStore-CaeYP7AG.js";function R(){var u;const{currentWeek:a,isLoadingWeek:y,createTask:g}=k(),{brainDumpItems:n,loadItems:l,deleteSelected:h,toggleSelection:x}=S(),{restDays:d}=N();m.useEffect(()=>{l()},[l]);const[r,c]=m.useState(!1),{sendMessage:f}=v(),b=async()=>{if(!a||r||n.length===0)return;c(!0);const i=`Your job is to convert a brain dump into a structured weekly plan using the 1-3-5 productivity system.
