import{u as k,b as N,r as m,j as e}from"./index-Da12JeCW.js";import{A as p,u as v}from"./AppLayout-pX05YmHn.js";import{D as w}from"./DayCardDistribution-B9ht3Lkk.js";import{u as S}from"./useBrainDumpStore-BaHhTgUY.js";function R(){var u;const{currentWeek:a,isLoadingWeek:y,createTask:g}=k(),{brainDumpItems:n,loadItems:l,deleteSelected:h,toggleSelection:x}=S(),{restDays:d}=N();m.useEffect(()=>{l()},[l]);const[r,c]=m.useState(!1),{sendMessage:f}=v(),b=async()=>{if(!a||r||n.length===0)return;c(!0);const i=`Your job is to convert a brain dump into a structured weekly plan using the 1-3-5 productivity system.
