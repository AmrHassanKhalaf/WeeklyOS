import{u as k,b as N,r as m,j as e}from"./index-DLbD0M5R.js";import{A as p,u as v}from"./AppLayout-CwU_2UQ9.js";import{D as w}from"./DayCardDistribution-DUTXmwiu.js";import{u as S}from"./useBrainDumpStore-DDZUprGT.js";function R(){var u;const{currentWeek:a,isLoadingWeek:y,createTask:g}=k(),{brainDumpItems:n,loadItems:l,deleteSelected:h,toggleSelection:x}=S(),{restDays:d}=N();m.useEffect(()=>{l()},[l]);const[r,c]=m.useState(!1),{sendMessage:f}=v(),b=async()=>{if(!a||r||n.length===0)return;c(!0);const i=`Your job is to convert a brain dump into a structured weekly plan using the 1-3-5 productivity system.
