import{e as ne,f as z,c as re,u as le,r as v,j as e}from"./index-CFMw273_.js";import{A as oe}from"./AppLayout-B2wvZSHj.js";import{B as N}from"./Button-Cu23qT_9.js";import{C as $,S as A,I as D,T as q}from"./Card-CcTNolle.js";import{S as de}from"./Section-DBU_q4_x.js";const B="#0b0b12",R="#131320",C="#1e2035",_="#e2e8f0",y="#64748b",k="#818cf8",M="#fb923c",H="#94a3b8",W="#4ade80",Z="#f87171",c="'Inter','Segoe UI',system-ui,sans-serif",X={monday:"MON",tuesday:"TUE",wednesday:"WED",thursday:"THU",friday:"FRI",saturday:"SAT",sunday:"SUN"};function U(t,r){const n=t.status==="done",s=t.title.replace(/</g,"&lt;").replace(/>/g,"&gt;"),a=n?W:"transparent",o=n?y:_,l=x=>x?`${Math.floor(x/60)}m`:"",p=t.estimatedTime?`<span style="flex-shrink:0;margin-left:6px;font-size:10px;font-family:${c};color:#a3a3a3;white-space:nowrap">Est: ${t.estimatedTime}</span>`:"",g=t.actualDuration?`<span style="flex-shrink:0;margin-left:6px;font-size:10px;font-family:${c};color:${r};white-space:nowrap;border:1px solid ${r}40;padding:2px 4px;border-radius:4px;background-color:${r}15">Spent: ${l(t.actualDuration)}</span>`:"";return`
  <div style="
